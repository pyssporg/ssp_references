...
| --- | --- | --- |
| INT | Intent | `docs/00-intent/intent.md` |
| PD | Product Decision | `docs/01-product-decisions/PD-*.md` |
| ADR | Architecture Decision Record | `docs/03-technical-decisions/ADR-*.md` |
| DD | Design Decision | `docs/03-technical-decisions/DD-*.md` |
| IMP | Improvement Candidate | `docs/06-evolution/backlog/IMP-*.md` and `docs/06-evolution/backlog/complete/IMP-*.md` |
