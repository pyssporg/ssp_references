...
def main() -> int:
    ...
    variants = [
        SimulationVariant(name="omsimulator_current", engine="omsimulator", version="current", start_time=0.0, stop_time=1.0, interval=0.01),
        SimulationVariant(name="ssp4sim_current", engine="ssp4sim", version="current", start_time=0.0, stop_time=1.0, interval=0.01),
    ]
