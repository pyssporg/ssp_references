...
This layer sits between [00-intent/intent.md](../00-intent/intent.md)
...
[00-intent/intent.md](../00-intent/intent.md) into durable promises. The
...
[Technical Decisions](../02-architecture/decisions/README.md) (ADRs and DDs).