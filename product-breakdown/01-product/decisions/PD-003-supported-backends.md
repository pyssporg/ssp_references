...
commitment in [00-intent/intent.md](../../00-intent/intent.md). The current
backend set is documented in
[04-verification/co_simulation_test_strategy.md](../../04-verification/co_simulation_test_strategy.md).
